...
export default function ReportForm() {
  ...
  const field = (label: string, key: keyof typeof form, placeholder: string) => (
    <label className="block">
      <span className="text-sm font-bold text-gray-100">{label} <span className="text-red-400">*</span></span>
      ...
      {loading ? null : !user ? (
        ...
        <section className="glass rounded-2xl p-8 border border-purple-500/10">
          <div className="space-y-4">
            ...
            <label className="block">
              <span className="text-sm font-bold text-gray-100">Доказательства <span className="text-red-400">*</span></span>
